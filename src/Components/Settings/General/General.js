...
import { PanelBody, PanelRow, SelectControl, RangeControl, TextControl, ToggleControl, __experimentalUnitControl as UnitControl } from '@wordpress/components';
...
const General = ({ setAttributes, mediaType, layout, carousel = {}, caption = {}, lightbox = {}, paginationType, perPage, loadMoreText, columns, columnGap, rowGap, coverImage }) => {
    ...
    return <>
        ...
        <PanelBody className='bPlPanelBody' title={__('Caption', 'embed-google-photos')} initialOpen={false}>
            ...
            {caption.show && <>
                ...
                <SelectControl className='mt10' label={__('Position', 'embed-google-photos')} labelPosition='side' value={caption.position || 'below'} options={captionPositionOpt} onChange={val => setCaption('position', val)} />
            </>}
        </PanelBody>
