 ...
 * ```
 */
export declare const RangeControl: import("react").ForwardRefExoticComponent<Pick<Pick<import("../base-control/types").BaseControlProps, "help" | "__nextHasNoMarginBottom" | "hideLabelFromVision"> & import("./types").NumericProps & {
