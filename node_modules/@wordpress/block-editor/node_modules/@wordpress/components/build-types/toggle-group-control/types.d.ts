...
export declare type ToggleGroupControlProps = Omit<FormElementProps<any>, 'defaultValue'> & Pick<BaseControlProps, 'help' | '__nextHasNoMarginBottom'> & {
    /**
     ...
     * @default false
     */
    __experimentalIsIconGroup?: boolean;
    /**
...
export declare type ToggleGroupControlContextProps = RadioStateReturn & Pick<ToggleGroupControlProps, 'size'> & {
    /**
     * Renders `ToggleGroupControl` as a (CSS) block element.
     *
     * @default false
