...
import { HStack } from '../h-stack'; // This conditional is needed to maintain the spacing before the slider in the `withSlider` case.
...
function FontSizePicker(_ref2, ref) {
  ...
  }, createElement(BaseControl.VisualLabel, null, __('Size'), headerHint && createElement("span", {
