 ...
 */
import { flow, reduce, first, last, omit, without, mapValues, isEqual, isEmpty, omitBy } from 'lodash';
/**
...
const withBlockTree = reducer => function () {
  ...
  switch (action.type) {
    ...
    case 'SAVE_REUSABLE_BLOCK_SUCCESS':
      {
        const updatedBlockUids = Object.keys(omitBy(newState.attributes, (attributes, clientId) => {
